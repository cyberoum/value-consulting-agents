...
export const CX_DATA = {
  "Aktia Bank_Finland": {
    ...
    "cx_strengths": [
      ...
      "Bilingual FI/SV service",
      "Personal advisory relationships"
    ],
    "cx_weaknesses": [
      "App features behind OP and Nordea",
      "Wealth advisory tools need digital upgrade",
      "Legacy platform constraining innovation",
      "Small scale limits tech investment"
    ],
  ...
  "Arion Bank_Iceland": {
    ...
    "cx_strengths": [
      "Most digitally ambitious Icelandic bank",
      "Fintech partnerships",
      "First to launch new features",
      "Open banking pioneer in Iceland"
    ],
    "cx_weaknesses": [
      "Smallest bank — scale disadvantage",
      "Feature richness doesn't compensate for smaller branch network",
      "Innovation sometimes outpaces customer adoption"
    ],
  ...
  "DNB_Norway": {
    ...
    "cx_strengths": [
      "Highest-rated Nordic bank app",
      "AI-driven financial insights and tips",
      "Vipps deeply integrated for payments",
      "Automated savings (round-ups, goals)",
      "Strong design and UX team"
    ],
    "cx_weaknesses": [
      "SME banking tools lag behind retail quality",
      "Wealth advisory digitalization incomplete",
      "Sbanken acquisition integration creating UX friction",
      "Corporate banking portal is separate ecosystem"
    ],
  ...
  "Danske Bank Finland_Finland": {
    "app_rating_ios": 4.5,
    "app_rating_android": 4.3,
    "app_name": "Danske Bank (Group app)",
    ...
    "cx_strengths": [
      "Group-level app quality"
    ],
    "cx_weaknesses": [
      "Smallest Danske market, lowest investment priority",
      "Finnish customers have OP and Nordea as stronger local alternatives"
    ],
    "digital_maturity": "MEDIUM (group platform)",
    "nps_estimate": "~20",
  ...
  "Danske Bank_Denmark": {
    ...
    "digital_channels": [
      "Mobile App",
      "Web Banking",
      "Vipps MobilePay stake",
      "Corporate Portal",
      "Sunday (now discontinued)"
    ],
    "cx_strengths": [
      "Strong mobile app with good feature set",
      "Vipps MobilePay integration",
      "Pan-Nordic app (DK, NO, SE, FI)",
      "Good business banking tools",
      "Dr Fiona Browne leading AI integration"
    ],
    "cx_weaknesses": [
      "AML scandal destroyed customer trust — still recovering",
      "Sunday (open banking) was shut down",
      "Lost customers to Nykredit and Jyske during scandal",
      "Compliance tech investment crowded out CX investment",
      "Pan-Nordic complexity creates inconsistencies"
    ],
  ...
  "Handelsbanken Norway_Norway": {
    "app_rating_ios": 4.1,
    "app_rating_android": 3.8,
    "app_name": "Handelsbanken NO (Group app)",
    ...
    "cx_strengths": [
      "Branch relationship model valued by existing customers"
    ],
    "cx_weaknesses": [
      "Same digital gaps as Swedish parent",
      "Norwegian competitors (DNB, Vipps) set much higher digital bar",
      "Weakest digital experience in Norwegian market"
    ],
  ...
  "Handelsbanken_Sweden": {
    ...
    "digital_channels": [
      "Mobile App",
      "Web Banking",
      "UK Mobile App (separate)"
    ],
    "cx_strengths": [
      "Personal relationship with branch manager is the 'channel'",
      "Reliable and secure",
      "Simple interface — not overwhelming"
    ],
    "cx_weaknesses": [
      "Lowest-rated major Nordic bank app",
      "Features significantly behind SEB/Nordea/DNB",
      "UK app on completely separate platform",
      "No AI features, no PFM, no engagement",
      "Digital experience contradicts the branch relationship promise"
    ],
    "digital_maturity": "LOW-MEDIUM",
    "nps_estimate": "~30",
  ...
  "Jyske Bank_Denmark": {
    ...
    "cx_strengths": [
      "Contrarian brand identity differentiates",
      "Branch 'experience centers' are innovative",
      "Private banking reputation",
      "Strong in Jutland region"
    ],
    "cx_weaknesses": [
      "Two digital experiences post-Handelsbanken acquisition",
      "App feels dated vs Danske Bank",
      "Private banking tools need digitalization",
      "Business banking features basic",
      "BEC dependency constrains innovation speed"
    ],
    "digital_maturity": "MEDIUM",
    "nps_estimate": "~30",
  ...
  "Klarna Bank_Sweden": {
    ...
    "cx_weaknesses": [
      "Trust concerns from BNPL debt",
      "Banking features (savings, checking) still immature",
      "Customer service complaints during rapid scaling",
      "Not perceived as a 'real bank' by older demographics"
    ],
    "digital_maturity": "VERY HIGH",
    "nps_estimate": "~45 (shopping), ~25 (banking)",
  ...
  "Landsbankinn_Iceland": {
    "app_rating_ios": 4.3,
    "app_rating_android": 4.1,
    "app_name": "Landsbankinn",
    ...
    "cx_strengths": [
      "Largest Icelandic bank — most features",
      "Post-crisis modernization mindset",
      "Good basic banking functionality"
    ],
    "cx_weaknesses": [
      "Island-scale limits feature investment",
      "No AI or advanced engagement features",
      "Tourism banking tools underdeveloped",
      "Limited wealth management digital"
    ],
    "digital_maturity": "MEDIUM",
    "nps_estimate": "~30",
  ...
  "Lunar_Denmark": {
    ...
    "cx_weaknesses": [
      "Profitability concerns affecting feature investment",
      "Customer service quality inconsistent",
      "Limited product breadth",
      "Trust concerns as venture-backed fintech",
      "Not yet profitable"
    ],
    "digital_maturity": "HIGH (tech) / LOW (business maturity)",
    "nps_estimate": "~30",
  ...
  "Länsförsäkringar_Sweden": {
    ...
    "cx_strengths": [
      "Combined insurance + banking in one app",
      "Strong regional brand trust",
      "Good mobile banking fundamentals",
      "BankID integration"
    ],
    "cx_weaknesses": [
      "Insurance and banking feel like two bolted-together apps",
      "23 regional variations create UX inconsistency",
      "No PFM or financial wellness features",
      "Business banking tools are basic",
      "Cross-product journey (insurance→bank) is clunky"
    ],
    "digital_maturity": "MEDIUM",
    "nps_estimate": "~35",
  ...
  "Municipality Finance (MuniFin)_Finland": {
    "app_rating_ios": 0,
    "app_rating_android": 0,
    "app_name": "N/A — No consumer app",
    "app_store_url": null,
    "play_store_url": null,
    "digital_channels": [
    ...
    "cx_strengths": [
      "Efficient bond issuance platform for municipalities"
    ],
    "cx_weaknesses": [
      "No consumer-facing digital banking at all — pure institutional"
    ],
    "digital_maturity": "N/A (no retail)",
    "nps_estimate": "N/A",
  ...
  "Nordea Denmark_Denmark": {
    "app_rating_ios": 4.6,
    "app_rating_android": 4.3,
    "app_name": "Nordea Mobile (Group app)",
    ...
    "cx_strengths": [
      ...
      "Pan-Nordic consistency"
    ],
    "cx_weaknesses": [
      "Losing Danish customers to Nykredit and Jyske",
      "Not perceived as 'Danish' enough",
      "Group decisions don't always prioritize Danish needs"
    ],
    "digital_maturity": "HIGH (group platform)",
    "nps_estimate": "~25 (lowest of Nordea markets)",
  ...
  "Nordea Finland_Finland": {
    "app_rating_ios": 4.6,
    "app_rating_android": 4.3,
    "app_name": "Nordea Mobile (Group HQ)",
    ...
    "cx_strengths": [
      "Group-level investment in digital",
      "5M+ users across Nordics",
      "Strong wealth management tools",
      "AI spending insights"
    ],
    "cx_weaknesses": [
      "One Platform transformation is slow",
      "Experience varies by market",
      "Younger Finns prefer OP or neobanks",
      "In-house build creates vendor resistance"
    ],
    "digital_maturity": "HIGH",
    "nps_estimate": "~35",
  ...
  "Nordea Norway_Norway": {
    ...
    "cx_strengths": [
      "Group-level app with full feature set",
      "Consistent pan-Nordic experience",
      "Strong Vipps integration"
    ],
    "cx_weaknesses": [
      "Norwegian-specific needs sometimes deprioritized vs group",
      "Losing local feel vs Norwegian-born competitors"
    ],
    "digital_maturity": "HIGH (group platform)",
    "nps_estimate": "~30 (lower than DNB in Norway)",
  ...
  "Nordea_Sweden": {
    ...
    "cx_strengths": [
      "Clean mobile UI with good transaction overview",
      "Strong BankID integration across Nordics",
      "Swish payments deeply integrated",
      "Multi-market login (one app, 4 countries)",
      "AI-driven spending categorization"
    ],
    "cx_weaknesses": [
      "Wealth management tools feel dated vs neobanks",
      "SME/Business app is separate and inferior",
      "Onboarding for new customers has friction",
      "Cross-sell within app is minimal",
      "No marketplace/beyond-banking features"
    ],
    "digital_maturity": "HIGH",
    "nps_estimate": "~35",
  ...
  "Nykredit_Denmark": {
    ...
    "cx_strengths": [
      "Strong mortgage origination flow",
      "Growing retail banking features",
      "Clean modern design language"
    ],
    "cx_weaknesses": [
      "Mortgage-centric — retail banking features feel bolted on",
      "Onboarding for non-mortgage customers is weak",
      "PFM and engagement features minimal",
      "Business banking tools basic",
      "Not built for daily banking engagement"
    ],
    "digital_maturity": "MEDIUM",
    "nps_estimate": "~30",
  ...
  "OP Financial Group_Finland": {
    ...
    "cx_strengths": [
      "Highly rated Finnish app",
      "Bancassurance integration (insurance+banking in one app)",
      "OP Light targeting young customers",
      "Strong loyalty program (OP bonuses)",
      "4.4M customers = massive user base feedback loop"
    ],
    "cx_weaknesses": [
      "120+ cooperative banks create inconsistency potential",
      "Insurance integration can feel cluttered",
      "Onboarding flow needs modernization",
      "Cross-sell between banking and insurance products is basic",
      "Multiple apps (main, Light, insurance) fragment the experience"
    ],
    "digital_maturity": "HIGH",
    "nps_estimate": "~40",
  ...
  "POP Bank Group_Finland": {
    ...
    "cx_strengths": [
      "Community presence in rural Finland"
    ],
    "cx_weaknesses": [
      "Most basic digital experience of any Finnish banking group",
      "Very limited features",
      "Aging shared platform",
      "Tiny budget for digital innovation"
    ],
  ...
  "S-Bank_Finland": {
    ...
    "digital_channels": [
      "Mobile App",
      "Web Banking",
      "S Group Loyalty App Integration"
    ],
    "cx_strengths": [
      "3M+ customer base from S Group loyalty",
      "S-Bonus integration",
      "Simple, accessible interface"
    ],
    "cx_weaknesses": [
      "Basic banking features",
      "Loyalty and banking not deeply integrated yet",
      "Limited lending and investment tools",
      "Banking overshadowed by S Group retail app"
    ],
    "digital_maturity": "MEDIUM",
    "nps_estimate": "~30",
  ...
  "SBAB_Sweden": {
    ...
    "cx_strengths": [
      "Fast digital mortgage application",
      "Clean simple UI",
      "Good rate comparison tools",
      "Transparent pricing"
    ],
    "cx_weaknesses": [
      "Narrow product range limits engagement",
      "No PFM beyond mortgage",
      "No business banking",
      "Limited investment/savings features",
      "Government-owned feel — lacks consumer appeal"
    ],
    "digital_maturity": "HIGH (for its niche)",
    "nps_estimate": "~40",
  ...
  "SEB_Sweden": {
    ...
    "cx_strengths": [
      "Call center ranked #1 in Sweden — excellent human channel",
      "Strong corporate/trading digital tools",
      "Solid mobile banking for daily transactions",
      "Good security and BankID integration"
    ],
    "cx_weaknesses": [
      "Retail app lacks engagement features",
      "Wealth advisory is primarily human, not digital-hybrid",
      "Cards experience is on separate platform",
      "Baltic customers on different digital experience",
      "No PFM or financial wellness features"
    ],
    "digital_maturity": "HIGH",
    "nps_estimate": "~40",
  ...
  "Savings Bank Group (Säästöpankki)_Finland": {
    "app_rating_ios": 4.1,
    "app_rating_android": 3.9,
    "app_name": "Säästöpankki",
    ...
    "cx_strengths": [
      "Community banking warmth",
      "Shared platform provides baseline",
      "Local trust in rural Finland"
    ],
    "cx_weaknesses": [
      "Aging shared platform",
      "Features lag behind OP significantly",
      "16 banks with varying digital expectations",
      "Limited tech budget vs larger competitors"
    ],
    "digital_maturity": "LOW-MEDIUM",
    "nps_estimate": "~25",
  ...
  "Sbanken_Norway": {
    ...
    "cx_strengths": [
      "Born-digital UX — Norway's first online bank",
      "Clean, intuitive interface",
      "Strong fund investment tools",
      "Loyal customer base"
    ],
    "cx_weaknesses": [
      "Under DNB ownership — losing independence",
      "Platform likely to be merged into DNB",
      "Innovation slowing since acquisition",
      "Uncertain brand future"
    ],
    "digital_maturity": "HIGH",
    "nps_estimate": "~40 (but declining post-acquisition)",
  ...
  "Skandiabanken_Sweden": {
    ...
    "cx_strengths": [
      "Pension management integration",
      "Fund investment tools",
      "Skandia brand trust"
    ],
    "cx_weaknesses": [
      "Banking feels secondary to pension/insurance",
      "Limited daily banking features",
      "No modern engagement capabilities",
      "Pension UX more developed than banking UX"
    ],
    "digital_maturity": "MEDIUM",
    "nps_estimate": "~30",
  ...
  "Spar Nord_Denmark": {
    ...
    "cx_strengths": [
      "Community banking warmth",
      "Personal service in northern Denmark",
      "Strong local loyalty"
    ],
    "cx_weaknesses": [
      "App is basic compared to national banks",
      "Limited features for smaller budget",
      "No PFM or engagement tools",
      "Scale disadvantage in technology investment"
    ],
    "digital_maturity": "LOW-MEDIUM",
    "nps_estimate": "~30",
  ...
  "SpareBank 1 SMN_Norway": {
    ...
    "digital_channels": [
      "Mobile App (shared Alliance)",
      "Web Banking",
      "Vipps"
    ],
    "cx_strengths": [
      "Same shared Alliance app as SR-Bank",
      "Innovation-forward within Alliance",
      "NTNU tech ecosystem proximity"
    ],
    "cx_weaknesses": [
      "Same Alliance app constraints as SR-Bank",
      "Can't differentiate digitally from other Alliance banks"
    ],
    "digital_maturity": "MEDIUM",
    "nps_estimate": "~35",
  ...
  "SpareBank 1 SR-Bank_Norway": {
    "app_rating_ios": 4.4,
    "app_rating_android": 4.2,
    "app_name": "SpareBank 1",
    "app_store_url": "https://apps.apple.com/app/sparebank-1-mobile-banking/id394458902",
    "play_store_url": "https://play.google.com/store/apps/details?id=no.sparebank1.mobilbank",
    "digital_channels": [
      "Mobile App (shared Alliance app)",
      "Web Banking",
      "Vipps Integration"
    ],
    "cx_strengths": [
      "Shared Alliance app provides scale advantages",
      "Vipps deeply integrated",
      "Good basic banking functionality",
      "Strong local brand trust in Rogaland"
    ],
    "cx_weaknesses": [
      "Shared Alliance app limits individual bank differentiation",
      "Digital features behind DNB",
      "Wealth management tools basic",
      "SME banking tools dated",
      "App feels generic across 14 Alliance banks"
    ],
    "digital_maturity": "MEDIUM",
    "nps_estimate": "~35",
  ...
  "SpareBank 1 Østlandet_Norway": {
    ...
    "cx_strengths": [
      "Alliance app provides baseline quality",
      "Eastern Norway community trust"
    ],
    "cx_weaknesses": [
      "Post-merger: customers from different banks adapting to shared app",
      "Alliance constraints on customization"
    ],
    "digital_maturity": "MEDIUM",
    "nps_estimate": "~30",
  ...
  "Storebrand Bank_Norway": {
    ...
    "cx_strengths": [
      "Pension management tools are strong",
      "ESG investment features",
      "Integrated pension+savings view"
    ],
    "cx_weaknesses": [
      "Banking features feel like a pension app add-on",
      "Limited daily banking capabilities",
      "No modern engagement features",
      "Small banking customer base limits investment"
    ],
    "digital_maturity": "MEDIUM (pension HIGH, banking LOW)",
    "nps_estimate": "~30",
  ...
  "Swedbank_Sweden": {
    ...
    "digital_channels": [
      "Mobile App",
      "Web Banking",
      "Baltic Apps (3 countries)",
      "Swish Integration"
    ],
    "cx_strengths": [
      "Large retail customer base means extensive testing",
      "Good Swish integration",
      "Baltic apps serve 3 additional markets",
      "Improving after post-AML technology investment"
    ],
    "cx_weaknesses": [
      "Post-AML brand damage still affects trust",
      "Baltic experience inconsistent with Swedish",
      "SME digital banking is basic",
      "Customer acquisition tools weak — losing to neobanks",
      "Design feels dated compared to Klarna/Nordea"
    ],
    "digital_maturity": "MEDIUM-HIGH",
    "nps_estimate": "~25",
  ...
  "Sydbank_Denmark": {
    ...
    "cx_strengths": [
      "Private banking relationship quality",
      "Cross-border DK-Germany capability",
      "Stable, reliable service"
    ],
    "cx_weaknesses": [
      "App features behind larger Danish banks",
      "Private banking tools need digital upgrade",
      "Limited innovation pace",
      "German subsidiary adds UX complexity"
    ],
    "digital_maturity": "MEDIUM",
    "nps_estimate": "~30",
  ...
  "TF Bank_Sweden": {
    ...
    "cx_strengths": [
      "Proprietary tech allows fast iteration",
      "14-country deployment from single platform",
      "Strong broker channel partnerships"
    ],
    "cx_weaknesses": [
      "NO real customer-facing app — broker-intermediated model",
      "Direct customer engagement essentially doesn't exist",
      "Rebranding to Avarda requires building CX from scratch",
      "200K cards growing to 1-2M needs engagement infrastructure",
      "No mobile banking app — critical gap"
    ],
  ...
  "Íslandsbanki_Iceland": {
    ...
    "cx_strengths": [
      "Post-IPO investment in digital",
      "Clean interface",
      "Good savings tools"
    ],
    "cx_weaknesses": [
      "Features similar to Landsbankinn — no differentiation",
      "Post-IPO cost pressure may limit spending",
