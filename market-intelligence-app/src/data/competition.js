...
export const COMP_DATA = {
  "Aktia Bank_Finland": {
    ...
    "competitive_threats": [
      "OP Financial Group",
      "Nordea",
      "Other Finnish banks in Swedish-speaking market"
    ],
    "backbase_competitors_at_bank": [
      "TietoEVRY components",
      "In-house build (limited capacity)",
      "Temenos (awareness)"
    ],
  ...
  "Arion Bank_Iceland": {
    ...
    "competitive_threats": [
      "Landsbankinn (scale advantage)",
      "Íslandsbanki (IPO momentum)"
    ],
    "backbase_competitors_at_bank": [
      "Fintech point solutions",
      "In-house (limited)"
    ],
  ...
  "DNB_Norway": {
    ...
    "key_vendors": [
      ...
      "Capgemini",
      "Microsoft Azure",
      "Vipps MobilePay (partial ownership)"
    ],
    ...
    "competitive_threats": [
      "SpareBank 1 Alliance (collective competition)",
      "Nordea Norway",
      "Sbanken (own subsidiary competing for digital-native customers)",
      "Bulder Bank (automated mortgage neobank)"
    ],
    "backbase_competitors_at_bank": [
      "In-house build",
      "Potential Temenos evaluation"
    ],
  ...
  "Danske Bank_Denmark": {
    ...
    "competitive_threats": [
      "Nykredit (gained market share during scandal)",
      "Jyske Bank (aggressive post-acquisition)",
      "Nordea Denmark",
      "Lunar (neobank)"
    ],
    "backbase_competitors_at_bank": [
      "In-house build",
      "Temenos (evaluated historically)"
    ],
  ...
  "Handelsbanken Norway_Norway": {
    ...
    "backbase_competitors_at_bank": [
      "Group-level — see Handelsbanken Group"
    ],
  ...
  "Handelsbanken_Sweden": {
    ...
    "competitive_threats": [
      "All other Swedish banks (digital gap widening)",
      "Neobanks capturing younger demographics",
      "ICA Banken (retail competitor)"
    ],
    "backbase_competitors_at_bank": [
      "Very few — greenfield opportunity"
    ],
  ...
  "Jyske Bank_Denmark": {
    ...
    "key_vendors": [
      "BEC (Bankernes EDB Central — shared Danish IT)",
      "JN Data",
      "In-house"
    ],
    ...
    "competitive_threats": [
      ...
      "Nykredit",
      "Nordea Denmark",
      "Sydbank (regional overlap)"
    ],
    "backbase_competitors_at_bank": [
      "BEC/JN Data ecosystem",
      "In-house (limited capacity)"
    ],
  ...
  "Klarna Bank_Sweden": {
    ...
    "competitive_threats": [
      ...
      "Afterpay/Block",
      "Apple Pay Later",
      "Traditional banks entering BNPL"
    ],
    "backbase_competitors_at_bank": [
      "N/A — builds everything in-house"
    ],
  ...
  "Landsbankinn_Iceland": {
    ...
    "competitive_threats": [
      "Íslandsbanki (direct competitor)",
      "Arion Bank (digital innovation)"
    ],
    "backbase_competitors_at_bank": [
      "In-house build (current approach)",
      "Very few international vendors active in Iceland"
    ],
  ...
  "Länsförsäkringar_Sweden": {
    ...
    "competitive_threats": [
      "Skandia (bancassurance competitor)",
      "ICA Banken (retail competitor)",
      "Nordea/SEB (scale advantage)"
    ],
    "backbase_competitors_at_bank": [
  ...
  "Municipality Finance (MuniFin)_Finland": {
    ...
    "backbase_competitors_at_bank": [
      "N/A — no engagement platform need"
    ],
  ...
  "Nordea Finland_Finland": {
    ...
    "competitive_threats": [
      "OP Financial Group (78% of Finland)",
      "S-Bank (loyalty scale)",
      "Neobanks",
      "Klarna"
    ],
    "backbase_competitors_at_bank": [
      "In-house build (primary risk)",
      "Temenos (historically evaluated)",
      "Potential Backbase opportunity as acceleration layer"
    ],
  ...
  "Nordea Norway_Norway": {
    ...
    "key_vendors": [
      "Temenos",
      "Finastra",
      "Local Norwegian fintech solutions"
    ],
    "vendor_risk": "Group-level decisions only. No local vendor engagement possible.",
    "competitive_threats": [
      "DNB (dominant local player)",
      "SpareBank 1 Alliance",
      "Local savings banks"
    ],
    "backbase_competitors_at_bank": [
      "Group-level decisions — see Nordea Group"
    ],
  ...
  "Nordea_Sweden": {
    ...
    "key_vendors": [
      ...
      "Microsoft Azure",
      "Salesforce CRM",
      "In-house engineering (~6K)"
    ],
    "vendor_risk": "Strong in-house capability may resist buying engagement layer. One Platform program is building internally.",
    "competitive_threats": [
      "Klarna (retail BNPL expanding to banking)",
      "Lunar (Nordic neobank)",
      "SEB (corporate/wealth competition)",
      "Local savings banks (community trust)"
    ],
    "backbase_competitors_at_bank": [
      "Temenos Infinity (evaluated)",
      "In-house build"
    ],
  ...
  "Nykredit_Denmark": {
    ...
    "competitive_threats": [
      "Danske Bank (recovering, still largest)",
      "Jyske Bank (aggressive)",
      "Nordea Denmark",
      "Lunar (neobank)"
    ],
    "backbase_competitors_at_bank": [
      "In-house build (risk)",
      "BEC (shared Danish bank IT)"
    ],
  ...
  "OP Financial Group_Finland": {
    ...
    "competitive_threats": [
      "Nordea Finland (main competitor)",
      "S-Bank (loyalty-driven)",
      "Savings Bank Group",
      "Finnish neobanks"
    ],
    "backbase_competitors_at_bank": [
  ...
  "SBAB_Sweden": {
    ...
    "competitive_threats": [
      "Major banks' mortgage operations",
      "Hypoteket (digital mortgage competitor)",
      "Avanza (savings competitor)"
    ],
    "backbase_competitors_at_bank": [
      "In-house (current approach)",
      "Limited scope reduces vendor interest"
    ],
  ...
  "SEB_Sweden": {
    ...
    "competitive_threats": [
      "Nordea (corporate overlap)",
      "EQT/private equity (wealth competition)",
      "Klarna (retail)",
  ...
  "Savings Bank Group (Säästöpankki)_Finland": {
    ...
    "competitive_threats": [
      "OP Financial Group (much larger competitor)",
      "Nordea Finland",
      "S-Bank",
      "POP Bank Group"
    ],
  ...
  "Sbanken_Norway": {
    ...
    "key_vendors": [
      "EVRY",
      "Stacc",
      "Traditional DNB vendors"
    ],
    "vendor_risk": "DNB subsidiary. All decisions through DNB. Sbanken platform likely to be gradually merged into DNB's.",
    "competitive_threats": [
      "Effectively competing against its own parent DNB for digital-native customers"
    ],
    "backbase_competitors_at_bank": [
      "DNB tech decisions apply"
    ],
  ...
  "Skandiabanken_Sweden": {
    ...
    "competitive_threats": [
      "Avanza (savings/investment)",
      "Nordea (full-service)",
      "Länsförsäkringar (bancassurance)"
    ],
    "backbase_competitors_at_bank": [
      "Skandia Group internal platform",
      "Pension platform vendors"
    ],
  ...
  "Spar Nord_Denmark": {
    ...
    "competitive_threats": [
      ...
      "Sydbank",
      "Danske Bank",
      "National banks entering northern Denmark"
    ],
    "backbase_competitors_at_bank": [
      "BEC platform"
    ],
  ...
  "SpareBank 1 SR-Bank_Norway": {
    ...
    "key_vendors": [
      "SpareBank 1 Utvikling (shared tech entity)",
      "Evry/TietoEVRY",
      "Sopra Steria"
    ],
    ...
    "competitive_threats": [
      "DNB (30% market share, superior digital)",
      "Nordea Norway",
      "Bulder Bank (automated mortgage)",
      "Fintechs"
    ],
    "backbase_competitors_at_bank": [
      "SpareBank 1 Utvikling in-house",
      "TietoEVRY legacy components",
      "Potential Temenos evaluation"
    ],
  ...
  "SpareBank 1 Østlandet_Norway": {
    ...
    "competitive_threats": [
      "DNB",
      "Nordea Norway",
      "Other Alliance banks in overlapping regions"
    ],
    "backbase_competitors_at_bank": [
      "Alliance shared platform"
    ],
  ...
  "Storebrand Bank_Norway": {
    ...
    "competitive_threats": [
      "DNB (full-service)",
      "KLP (pension competitor)",
      "Nordea (wealth)"
    ],
    "backbase_competitors_at_bank": [
      "Storebrand Group internal",
      "Pension platform vendors"
    ],
  ...
  "Swedbank_Sweden": {
    ...
    "competitive_threats": [
      "Nordea (main retail competitor)",
      "Klarna/neobanks",
      "Handelsbanken (trust advantage)",
      "SEB (corporate overlap)"
    ],
    "backbase_competitors_at_bank": [
      "TietoEVRY ecosystem",
      "Temenos (awareness)"
  ...
  "Sydbank_Denmark": {
    ...
    "competitive_threats": [
      "Danske Bank",
      "Nykredit",
      "Jyske Bank (regional overlap in Jutland)",
      "Nordea Denmark"
    ],
    "backbase_competitors_at_bank": [
      "BEC ecosystem",
      "In-house on BEC platform"
    ],
  ...
  "TF Bank_Sweden": {
    ...
    "competitive_threats": [
      "Other pan-European digital lenders",
      "Local banks in each of 14 markets",
      "Credit intermediaries/brokers"
    ],
    "backbase_competitors_at_bank": [
      "None — greenfield",
      "Potential to build in-house but 300 staff for 14 countries limits capacity"
    ],
  ...
  "Íslandsbanki_Iceland": {
    ...
    "competitive_threats": [
      "Landsbankinn (larger competitor)",
      "Arion Bank (more innovative)"
    ],
    "backbase_competitors_at_bank": [
      "In-house",
      "Limited international vendor presence"
    ],
